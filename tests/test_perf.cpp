...
int main(int argv, char **argc) {
  ...
  class test :
      public Agglomerator_Anisotropic<CoMMAIndexT, CoMMAWeightT, CoMMAIntT> {
  public:
    test(
      Dual_Graph<CoMMAIndexT, CoMMAWeightT, CoMMAIntT> &graph,
    ...
    ~test(){};
    CoMMAIntT test_variable() { return (_threshold_card); };
  };
